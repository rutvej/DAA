...
def main():
    ...
    if provider_choice == "2":
        ...
        pull_choice = get_input("Would you like to pull the model automatically? (y/n)", "y").lower()
        if pull_choice == "y":
            if shutil.which("ollama"):
                ...
                try:
                    ...
                    print("Failed to pull model automatically. Ensure Ollama is running.")
            else:
                print("Ollama CLI not found in path. Please pull the model manually: 'ollama pull " + model + "'")
    else:
    ...
    jira_url = get_input("Jira Site URL (Optional, e.g. https://your-domain.atlassian.net)")
